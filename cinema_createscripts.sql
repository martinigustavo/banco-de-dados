...
CREATE TABLE IF NOT EXISTS filme (
	...
	CONSTRAINT fk_id_elenco_filme FOREIGN KEY (id_elenco) REFERENCES elenco,
...
CREATE TABLE IF NOT EXISTS generofilme (
	...
	CONSTRAINT pk_generofilme PRIMARY KEY (id_genero, id_filme),
...
CREATE TABLE IF NOT EXISTS bilheteriaingresso (
	...
	CONSTRAINT pk_bilheteriaingresso PRIMARY KEY (id_ingresso, id_bilheteria),
